...
- 技術スタック: HTML / CSS / JavaScript（フレームワークなし、ビルドツールなしのシンプル構成）
...
- ビルドステップなし。`index.html` をブラウザで開く、または簡易サーバーで配信して動作確認する（例: `npx serve` や VS Code の Live Server 拡張など）。
- lint / test ツールを導入したらここに追記する。
